...
import { Paper, FormControl, InputLabel, Grid, FormControlLabel, Checkbox, Button, Input, Tabs, Tab, Box, FormHelperText, MenuItem, Select, IconButton } from '@mui/material';
...
function AddOrganizationGateway() {
  ...
  const URL2 = "http://203.162.235.53:8080/api/network-servers?limit=1000";
    ...
    const fetchServiceData = () => {
      const URL = "http://203.162.235.53:8080/api/service-profiles?limit=1000&organizationID="+path[2]+"&networkServerID=" + networkServerID; 
      fetch(URL, header)
            .then((res) =>
                res.json())
    ...
    const fetchGwData = () => {
      const URL = "http://203.162.235.53:8080/api/gateway-profiles?limit=1000&organizationID="+path[2]+"&networkServerID=" + networkServerID; 
      fetch(URL, header)
            .then((res) =>
                res.json())
...
const URL = "http://203.162.235.53:8080/api/gateways";
    ...
    <section className="home">
      ...
      <TabPanel value={value} index={0}>
          ...
          <Grid item xs={12} sm={6}>
            <Button variant="contained" onClick={handleGatewaySubmit}> Add Gateway </Button>
          </Grid>
