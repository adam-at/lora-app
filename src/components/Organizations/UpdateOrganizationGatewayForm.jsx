...
import { Paper, FormControl, InputLabel, Grid, FormControlLabel, Checkbox, Button, Input, FormHelperText, Tabs, Tab, Box, MenuItem, Select, IconButton } from '@mui/material';
