...
function GatewayDetails(props) {
  ...
  const URLdevice = "http://203.162.235.53:8080/api/devices/" + path[6];
  const URLdeviceProfile = "http://203.162.235.53:8080/api/device-profiles/";
...
const URLstats = "http://203.162.235.53:8080/api/devices/" + path[6] + "/stats?interval=DAY&startTimestamp="+start+"&endTimestamp="+end;
